        ...
        <aside id="sidebar"
            ...
            <nav class="p-4 space-y-2 text-sm">
                ...
                <a href="{{ route('dashboard') }}"
                    class="flex items-center gap-3 p-2 rounded {{ request()->routeIs('dashboard') ? 'bg-blue-500 text-white hover:bg-blue-600' : 'hover:bg-gray-200' }}">
                    <span>
                    ...
                    <a href="{{ route('pos.index') }}"
                        class="flex items-center gap-3 p-2 rounded {{ request()->routeIs('pos.*') ? 'bg-blue-500 text-white hover:bg-blue-600' : 'hover:bg-gray-200' }}">
                        <span>
                            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        ...
                        <a href="{{ route('categories.index') }}"
                            class="flex items-center gap-3 p-2 rounded {{ request()->routeIs('categories.*') ? 'bg-blue-500 text-white hover:bg-blue-600' : 'hover:bg-gray-200' }}">
                            <span>
                        ...
                        <a href="{{ route('sizes.index') }}"
                            class="flex items-center gap-3 p-2 rounded {{ request()->routeIs('sizes.*') ? 'bg-blue-500 text-white hover:bg-blue-600' : 'hover:bg-gray-200' }}">
                            <span>
                                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        ...
                        <a href="{{ route('products.index') }}"
                            class="flex items-center gap-3 p-2 rounded {{ request()->routeIs('products.*') ? 'bg-blue-500 text-white hover:bg-blue-600' : 'hover:bg-gray-200' }}">
                            <span>
                                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        ...
                        <a href="{{ route('sales.index') }}"
                            class="flex items-center gap-3 p-2 rounded {{ request()->routeIs('sales.*') ? 'bg-blue-500 text-white hover:bg-blue-600' : 'hover:bg-gray-200' }}">
                            <span>
                        ...
                        <a href="{{ route('reports.index') }}"
                            class="flex items-center gap-3 p-2 rounded {{ request()->routeIs('reports.*') ? 'bg-blue-500 text-white hover:bg-blue-600' : 'hover:bg-gray-200' }}">
                            <span>
                        ...
                        <a href="{{ route('users.index') }}"
                            class="flex items-center gap-3 p-2 rounded {{ request()->routeIs('users.*') ? 'bg-blue-500 text-white hover:bg-blue-600' : 'hover:bg-gray-200' }}">
                            <span>
                                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        ...
                        <a {{-- <a href="{{ route('settings.index') }}" --}} class="flex items-center gap-3 p-2 rounded hidden">
                            <span>
                                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
